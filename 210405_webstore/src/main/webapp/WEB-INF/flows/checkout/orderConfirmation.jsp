	...
	<div class="container">
		<div class="row">
			<form:form modelAttribute="order" class="form-horizontal">
				...
				<div
					class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1
col-md-offset-3">
					...
					<div class="row">
						<div class="col-xs-6 col-sm-6 col-md-6">
							<address>
								...
								${order.shippingDetail.shippingAddress.wideCiDo} <br>
								${order.shippingDetail.shippingAddress.ciGoonGu},
								${order.shippingDetail.shippingAddress.streetName} <br>
								${order.shippingDetail.shippingAddress.buildingNo},
								${order.shippingDetail.shippingAddress.unitNo} <br>
							</address>
						</div>
					...
					<div class="row">
						<div class="col-xs-6 col-sm-6 col-md-6">
							<address>
								...
								${order.shippingDetail.shippingAddress.streetName} <br>
								${order.shippingDetail.shippingAddress.buildingNo},
								${order.shippingDetail.shippingAddress.unitNo} <br> <abbr
									title="Phone">P:</abbr> ${order.customer.phoneNumber}
							</address>
						</div>
					</div>
					<div class="row">
							...
							<tbody>
								<c:forEach var="cartItem" items="${order.cart.cartItems}">
									<tr>
										...
										<td class="col-md-1
text-center">$${cartItem.product.unitPrice}</td>
										<td class="col-md-1
text-center">$${cartItem.totalPrice}</td>
									</tr>
								</c:forEach>
								<tr>
									<td></td>
